document.addEventListener('DOMContentLoaded', () => {
        ...
        }
 {
        ...
        description: "Tank Arena is an online tank battle game that you can play with your friend on the same device.",
  ...
  },
  {
    ...
    searchButton.addEventListener('click', () => {
        ...
        searchResults.textContent = `Found ${foundGames.length} of ${games.length} games`;
    });
    ...
    window.addEventListener('popstate', () => {
        ...
        if (gameTitle) {
            const game = games.find(g => g.title === decodeURIComponent(gameTitle));
