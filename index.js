...
// Hidden login URL
const loginUrl = "vgames1.github.io/login?pageid=72349vxs";
document.getElementById('loginLink').href = loginUrl;

// Check URL for access level
...
function renderGames() {
  ...
  const allowedGames = accessLevel === 'accepted' ? games : games.slice(0, 3);
  ...
  allowedGames.forEach(game => {
    ...
    gameCard.innerHTML = `
      ...
      <div class="tags">Tags: ${game.tags}</div>
    `;
